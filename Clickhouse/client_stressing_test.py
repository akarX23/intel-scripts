...
if __name__ == "__main__":
    ...
    if len(sys.argv) != 4:
        print(
            "usage: python3 client_stressing_test.py [queries_file_path] [client_number] [stress_duration]"
        )
        sys.exit()
    else:
        ...
        print(
            "queries_file_path: %s, client_number: %d, duration: %d" % (queries_list, client_number, duration)
        )
    ...
    for q in queries:
        ...
        for j in range(0, retest_number):
            ...
            curr_loop = int(duration * calculated_runs / totalT) + 1
            print(
            ...
            if totalT > (duration - retest_tolerance) and totalT < (
                duration + retest_tolerance
            ):
                break
            else:
                print(
